        ...
        <>
            ...
            >
                <Box sx={{
                    ...
                    {
                        isDisplayAnswer ? <RemoveCircleOutlineOutlinedIcon sx={{
                            fontSize: 20
                        }} /> : <ControlPointIcon sx={{
                            fontSize: 20
                        }} />
                ...
                <Box className="question-text">
                    ...
                    <Typography className="otherInfo" >requested by: Vishnu  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;requested on: 22/01/2024
                       <span  ><RemoveRedEyeOutlinedIcon className='viewIcon' /></span> 9
                    </Typography>
                </Box>
